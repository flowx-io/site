    ...
    <section className="px-4 md:px-20 ">
      ...
      <div className="flex flex-col md:flex-row gap-8 pb-8 md:pb-0">
        <Card
          ...
          title="علاقات أقوى"
          description="احتفظ بالمتبرعين لفترة أطول من خلال التواصل المخصص"
        />
        <Card
          icon="/icons/target.png"
          title="استهداف دقيق"
          description="قسم متبرعيك حسب السلوك والاهتمامات لرسائل أكثر تأثيراً"
        />
        <Card
          icon="/icons/chart-up.png"
          title="زيادة في التبرعات"
          description="العملاء يشهدون زيادة بمعدل 35% في التبرعات خلال 6 أشهر"
        />
      </div>
...
const Card = ({ icon, title, description }: { icon: string, title: string, description: string }) => {
  return (
    <div className="border border-[#F2F2F2] p-6 md:p-14 flex-1 rounded-[12px] flex flex-col justify-center items-center">
      <Image
        src={icon}
        alt={title}
        width={120}
